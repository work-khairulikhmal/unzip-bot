...
Report this at @MisterKarlos if you think this is a mistake, I may unban you
    """
...
**Powered by @MisterKarlosChannel**
    """
    ...
    BOT_RUNNING = "Bot is running now ! Join @MisterKarlosChannel"
...
Successfully extracted by @TG_Unzip_Bot 🥰
    """
...
Please report this at @MisterKarlos if you think this is a serious error
    """
...
**• I wanna have help 🥺**
    ...
    PM me at **@MisterKarlos** or join the chat **@MisterKarlos**
    """
...
3) Send a screenshot of your payment to **@MisterKarlos**
...
If you believe it's an error, send the file to **@MisterKarlos**
    """
...
Please contact @MisterKarlos with details and screenshots
    """
...
If it fails again, it means that {} haven't started the bot yet (or deleted the chat), or he's private/banned/whatever
    ...
    REPORT_REPLY = "Reply to a message to report it to @MisterKarlos"

    REPORT_DONE = """
Report sucessfully sent ! An answer will arrive soon

Note : if you need to reply to replies, always use that /report command (or join **@MisterKarlosChannel**)
    """
...
**/logs** : Send you the logs (all of them). Useful for bug tracking. Send them to **@MisterKarlos** if you don't understand them/need help
